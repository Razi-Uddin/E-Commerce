<div class="row">
	<div class="box box-solid" style="background-color:pink; color:white;">
	  	<div class="box-header with-border">
	    	<h3 class="box-title"  style="color:Black;"><b>Most Viewed Today</b></h3>
	  	</div>
	  	<div class="box-body">
	  		<ul id="trending">
	  		<?php
	  			...
	  			foreach($stmt as $row){
	  				echo "<li><a href='product.php?product=".$row['slug']."'  style='color:white;'>".$row['name']."</a></li>";
	  			}
